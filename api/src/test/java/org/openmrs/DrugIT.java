 ...
 */
public class DrugIT extends BaseContextMockTest {
	...
	public void addDrugReferenceMap_shouldSetDrugAsTheDrugToWhichAMappingIsBeingAdded() throws Exception {
		...
		ConceptMapType defaultConceptMapType = new ConceptMapType(2);
		defaultConceptMapType.setName("same-as");
		defaultConceptMapType.setIsHidden(false);

		when(conceptService.getDefaultConceptMapType()).thenReturn(defaultConceptMapType);
